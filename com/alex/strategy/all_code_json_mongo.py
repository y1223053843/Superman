...
if (param == 1):
    ...
    # 策略2
    toDataFrame({},{'$or':[{'MACD_Z_W':'[V]'},{'MACD_Z_W':'[/]'}, {'04_Code':{'$in':[u'000001',u'399001',u'399006']},'07_所属行业': {'$exists':False}},{'04_是否持有' : 'yes'}]},'All_Code_JSON_Mongo','S2：:week upper，888 signal')
    # 策略3
